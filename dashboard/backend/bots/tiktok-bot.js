...
class TikTokBotWrapper {
    ...
    async start() {
        try {
            ...
            // Create instance of the TikTok bot
            this.bot = new TikTokBot(this.session.profileType || 'gen-z-tech-enthusiast', config);
...
module.exports = TikTokBotWrapper;